# This file is based on a template generated by NixOS.
# The original template portion may be licensed under the MIT License.
# My additions and modifications are released under the CC0 license.
